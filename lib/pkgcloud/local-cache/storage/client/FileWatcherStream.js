 ...
 * @constructor
 */
var FileWatcherStream = exports.FileWatcherStream = function(path, options )
{
...
FileWatcherStream.prototype._readFile = function() {
  ...
  this.on('error', this._handleWriteError.bind(this));
  this.on('data', this._handleWriteData.bind(this));
  this.on('end', this._handleWriteEnd.bind(this));
};
...
FileWatcherStream.prototype._handleReadEnd = function() {
  ...
  if( this._fileComplete )
    stream.Readable.prototype.end.call(this);
};

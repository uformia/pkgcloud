...
var Client = exports.Client = function(options) {
  ...
  /**
   * @typedef {object} InProgress
   */

  /**
   * @typedef {object<string,InProgress>} FilesInProgress
   */
...
Client.prototype.touchFile = function( options ) {
  ...
  this._inProgress[container][remote] = this._inProgress[container][remote] || {};  // New InProgress here
};
